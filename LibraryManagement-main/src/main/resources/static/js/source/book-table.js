		...
		if (!empty) {
			...
			if (id == "") {
				...
				success: function(result) {
					...
					$(".add-new").removeAttr("disabled");
					$('.success').message('Created Book Success: ' + isbn + ' | ');
window.location.reload();
				...
				error: function(e) {
					console.log(e);
					$('.error').message('Created Book Failed: ' + isbn + ' | ');
				}
			});
...
$.ajax({
				...
				success: function(result) {
					...
					$(".add-new").removeAttr("disabled");
					$('.success').message('Updating App Success: ' + isbn + ' | ');
window.location.reload();
	...
	$(".add-new").click(function() {
		...
		var row = '<tr>' +
			'<td></td>' +
			'<td><input type="text" class="form-control" name="isbn" id="appId"></td>' +
			'<td><input type="text" class="form-control" name="title" id="code"></td>' +
			'<td><input type="text" class="form-control" name="author" id="hosting"></td>' +
			'<td></td>' +
